"""Generate and verify the checked-in MFQ Server OpenAPI contract."""
...
from mfq.server.models import PROTOCOL_VERSION
...
def build_openapi_schema() -> dict[str, Any]:
    ...
    schema["x-mfq-protocol-version"] = PROTOCOL_VERSION
    schema["x-mfq-websocket"] = {
        "path": "/api/v1/realtime",
        "frameSchema": "#/components/schemas/RealtimeFrame",
        "events": REALTIME_EVENTS,
    }
    from mfq.server.models import RealtimeFrame
