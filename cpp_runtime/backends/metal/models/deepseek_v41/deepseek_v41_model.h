...
struct DeepseekV41VisionConfig {
...
// Complete normalized contract for the CED/CSA2 DeepSeek-V4.1 family.
// This is intentionally not convertible to DeepseekV4Config.
struct DeepseekV41Config {
    ...
    double rope_theta = 10'000.0;
    DeepseekV41RopeScaling rope_scaling;
    ...
    DeepseekV41VisionConfig vision;

    static DeepseekV41Config from_json(std::string_view payload);
    static DeepseekV41Config from_mfq(const MfqContainer& model);
    void validate() const;
