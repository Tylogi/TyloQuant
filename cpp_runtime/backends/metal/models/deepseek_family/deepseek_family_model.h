...
// Canonical names for the format-preserving execution core. The V4-prefixed
// names above remain source-compatible for external users.
using DeepseekFamilyConfig = DeepseekV4Config;
using DeepseekFamilyTensorNames = DeepseekV4TensorNames;
